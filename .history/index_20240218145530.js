...
const routerteachers = require('./rautes/teachers')
const accountant = require('./rautes/accountants')
const students = require('./rautes/students')
...
app.use('/accountants', accountant)
